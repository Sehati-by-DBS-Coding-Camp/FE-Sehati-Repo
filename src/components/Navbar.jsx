...
import { FiHome, FiUserCheck, FiFileText, FiLogIn, FiUserPlus } from 'react-icons/fi'
...
export default function Navbar() {
    ...
    return (
        <header className="bg-background shadow-sm sticky top-0 z-50">
            <div className="max-w-7xl px-4 md:px-8 mx-auto py-2 flex items-center justify-between">
                {/* Logo kiri */}
                <div className="flex items-center md:flex-1 w-1/3 md:w-auto">
                    <img src="/images/SEHATI.png" alt="Logo SEHATI" className="h-12 w-auto" />
                </div>
                ...
                <nav className="hidden md:flex flex-1 justify-center space-x-20">
                    <Link to="/" className="text-black/60 font-medium hover:underline text-md">Beranda</Link>
                    <Link to="/evaluasi-diri" className="text-black/60 font-medium hover:underline text-md">Evaluasi Diri</Link>
                    <Link to="/berita" className="text-black/60 font-medium hover:underline text-md">Berita</Link>
                </nav>
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {dropdownOpen && (
                                <div
                                    ...
                                    transition-all duration-300 ease-out transform ${dropdownOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"
                                        }`}
                                >
                                    <Link
                                        to="/profile"
                    ...
                    >
                        ...
                        <nav className="flex flex-col gap-2">
                            <NavLink
                                ...
                                onClick={toggleMobileMenu}
                                className={({ isActive }) =>
                                    `w-full px-4 py-2 rounded-xl text-left font-medium transition text-accent ${isActive ? 'bg-white text-accent' : 'bg-secondary text-black hover:bg-white'
                                    }`
                                }
                            >
                            ...
                            <NavLink
                                ...
                                onClick={toggleMobileMenu}
                                className={({ isActive }) =>
                                    `w-full px-4 py-2 rounded-xl text-left font-medium transition text-accent ${isActive ? 'bg-white text-accent' : 'text-black bg-secondary hover:bg-white'
                                    }`
                                }
                            >
                                <div className="flex items-center gap-2">
                            ...
                            {!isLoggedIn && (
                                <>
                                    ...
                                    <NavLink
                                        ...
                                        onClick={toggleMobileMenu}
                                        className={({ isActive }) =>
                                            `w-full px-4 py-2 rounded-xl text-left font-medium transition text-accent ${isActive ? 'bg-white text-accent' : 'bg-secondary hover:bg-white text-black'
                                            }`
                                        }
                                    >
                                        <div className="flex items-center gap-2">
