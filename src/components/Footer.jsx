...
export default function Footer() {
    return (
        <footer className="bg-background text-gray-800 py-4 px-4">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:flex md:items-center md:justify-between gap-6">
                {/* Logo */}
                <div className="flex justify-center md:justify-start mb-0 md:w-1/3">
                    <img src="/images/SEHATI.png" alt="Logo SEHATI" className="w-30 md:w-24 h-auto" />
                </div>
                ...
                <div className="text-center md:text-left mb-0 md:flex-1 md:flex md:justify-center">
                    <div className="md:w-max">
                        ...
                        <ul className="space-y-1 text-sm text-accent">
                            ...
                            <li><a href="/about" className="hover:underline">Evaluasi Diri</a></li>
                            <li><a href="/products" className="hover:underline">Berita</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="text-center md:text-right md:w-1/3 md:flex md:flex-col md:justify-center md:items-end">
                    <div>
                        <h3 className="font-semibold text-sm mb-2 text-accent">Hubungi Kami</h3>
